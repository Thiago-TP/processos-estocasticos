...
\begin{itemize}
    ...
    \item [c)] Este processo é randômico ou estacionário no sentido amplo (Wide-Sense Stationary, WSS)? Justifique.
\end{itemize}
...
\begin{itemize}
    ...
    \item [c)] $\mu[n]$ é constante e $R[m,n]$ depende apenas da diferença $m-n$, tornando o processo WSS.
\end{itemize}

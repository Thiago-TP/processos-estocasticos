...
from calculo_de_features_trabalho_6 import rgb_para_cinza
...
def comparar_grayscale(arquivo: str, dir_saida: str = "trabalho_6/plots"):
    ...
    imagem_cinza = rgb_para_cinza(
        imagem_rgb * maximos.squeeze()
    )  # Multiplica pela escala original para manter a faixa de valores
    ...
    plot_rgb_cubo(
        [ax5, ax6, ax7, ax8],
        np.stack([imagem_cinza] * 3, axis=-1),
